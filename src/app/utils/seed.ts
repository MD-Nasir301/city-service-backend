	...
	try {
		const categories = [
			// FREE SERVICES
			{
				...
				description:
					"Report uncollected garbage, overflowed dustbins, or illegal dumping.",
			...
			},
			{
				...
				description:
					"Report potholes, broken pavements, or hazardous road damage.",
				type: CategoryType.FREE,
				basePrice: 0,
				unitName: null,
			},
			{
				...
				description:
					"Report blocked drains, waterlogging, or overflowing manholes.",
				type: CategoryType.FREE,
				basePrice: 0,
				unitName: null,
			},
			{
				...
				description:
					"Report hazardous tree branches on public roads or park maintenance needs.",
				type: CategoryType.FREE,
				basePrice: 0,
				unitName: null,
			},
			...
			// PAID SERVICES
			{
				...
				description:
					"Hire dedicated city staff for bulk construction waste or private debris removal.",
			...
			},
			{
				...
				description:
					"Request specialized staff and equipment for private property drainage cleanout.",
				type: CategoryType.PAID,
				basePrice: 800.0,
			...
			},
			{
				...
				description:
					"Hire municipal staff for safe cutting or pruning of private garden trees.",
				type: CategoryType.PAID,
				basePrice: 500.0,
				unitName: "Per Tree",
			},
